...
import Draft from '@/components/battle/DraftV2'
...
export default function FriendGameWrapper() {
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [gameScreen, p1Trainer])  // p1Trainer in deps: re-fires if trainer arrives after screen change
  ...
  const screens: Record<string, React.ReactNode> = {
    ...
    defeat:         <DefeatScreen />,
    result:         <ResultsScreen />,  // uses matchResults from game-store (works in Friend Battle)
  }
